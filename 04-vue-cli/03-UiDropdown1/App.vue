<template>
  <div class="sample container">
    ...
    <p>
      <ui-dropdown v-model:modelValue="selectedType" :options="agendaItemTypes" title="Событие" />
    </p>
    <p>selectedLang = {{ selectedLang }}</p>
    <p>
      <ui-dropdown v-model:modelValue="selectedLang" :options="langOptions" title="Язык" />
    </p>
  </div>
</template>
