...
export default {
  ...
  emits: ['update:meetup', 'cancel', 'submit'],
  ...
  watch: {
    ...
    localMeetup: {
      deep: true,
      handler() {
        this.$emit('update:meetup', cloneDeep(this.localMeetup));
      },
    },
  },
  ...
  methods: {
    ...
    addAgendaItem() {
      ...
      this.localMeetup = {
        ...
        agenda: [
          ...agenda,
          createAgendaItem({
            startsAt: agenda.length
              ? agenda[agenda.length - 1].endsAt
              : '00:00',
          }),
        ],
      };
    ...
    updateAgendaItem(index, item) {
      this.localMeetup.agenda[index] = item;
    },
  },
};
</script>
